...
import { capNhatPhimUploadAction, thongTinPhimAction } from '../../redux/action/QuanLyPhim/QuanLyPhimAD';
        ...
        <Fragment>
            ...
            >
                ...
                <Form.Item label="Sắp chiếu" valuePropName="checked">
                    <Switch style={{ width: 20 }} onChange={handleChangeSwitch('sapChieu')} checked={formik.values.sapChieu} />
                </Form.Item>
                <Form.Item label="Hot" valuePropName="checked">
                    <Switch style={{ width: 20 }} onChange={handleChangeSwitch('hot')} checked={formik.values.hot} />
                </Form.Item>
                ...
                <Form.Item label="Hình ảnh">
                    ...
                    <br />
                    <img style={{ width: 150, height: 150 }} src={img === '' ? thongTinPhimAD.hinhAnh : img} alt="..." />
                </Form.Item>
